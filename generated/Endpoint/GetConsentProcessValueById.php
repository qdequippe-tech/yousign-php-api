...
class GetConsentProcessValueById extends \Qdequippe\Yousign\Api\Runtime\Client\BaseEndpoint implements \Qdequippe\Yousign\Api\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{id}'], [$this->id], '/consent_process_values/{id}');
    }
