...
class GetProceduresByIdProof extends \Qdequippe\Yousign\Api\Runtime\Client\BaseEndpoint implements \Qdequippe\Yousign\Api\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{id}'], [$this->id], '/procedures/{id}/proof');
    }
