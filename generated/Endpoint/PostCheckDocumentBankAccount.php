...
class PostCheckDocumentBankAccount extends \Qdequippe\Yousign\Api\Runtime\Client\BaseEndpoint implements \Qdequippe\Yousign\Api\Runtime\Client\Endpoint
{
     ...
     * }
     */
    public function __construct(\Qdequippe\Yousign\Api\Model\CheckDocumentBankAccountsInput $body, array $headerParameters = [])
    {
        $this->body = $body;
    ...
    {
        return '/check-document/bank_accounts';
    }
    ...
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (400 === $status) {
            throw new \Qdequippe\Yousign\Api\Exception\PostCheckDocumentBankAccountBadRequestException();
        }
    }
