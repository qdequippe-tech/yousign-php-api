...
class PostConsentProcess extends \Qdequippe\Yousign\Api\Runtime\Client\BaseEndpoint implements \Qdequippe\Yousign\Api\Runtime\Client\Endpoint
{
     ...
     * }
     */
    public function __construct(\Qdequippe\Yousign\Api\Model\ConsentProcessInput $body, array $headerParameters = [])
    {
        $this->body = $body;
