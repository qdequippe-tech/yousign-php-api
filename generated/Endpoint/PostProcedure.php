...
class PostProcedure extends \Qdequippe\Yousign\Api\Runtime\Client\BaseEndpoint implements \Qdequippe\Yousign\Api\Runtime\Client\Endpoint
{
     ...
     * }
     */
    public function __construct(\Qdequippe\Yousign\Api\Model\ProcedureInput $body, array $headerParameters = [])
    {
        $this->body = $body;
    ...
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (400 === $status) {
            throw new \Qdequippe\Yousign\Api\Exception\PostProcedureBadRequestException();
        }
    }
