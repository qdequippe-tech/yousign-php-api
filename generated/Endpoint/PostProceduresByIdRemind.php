...
class PostProceduresByIdRemind extends \Qdequippe\Yousign\Api\Runtime\Client\BaseEndpoint implements \Qdequippe\Yousign\Api\Runtime\Client\Endpoint
{
     ...
     * }
     */
    public function __construct(string $id, \Qdequippe\Yousign\Api\Model\ProcedureRemindInput $body, array $headerParameters = [])
    {
        $this->id = $id;
        $this->body = $body;
    ...
    {
        return str_replace(['{id}'], [$this->id], '/procedures/{id}/remind');
    }
    ...
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (404 === $status) {
            throw new \Qdequippe\Yousign\Api\Exception\PostProceduresByIdRemindNotFoundException();
        }
    }
