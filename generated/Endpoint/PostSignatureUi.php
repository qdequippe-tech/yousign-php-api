...
class PostSignatureUi extends \Qdequippe\Yousign\Api\Runtime\Client\BaseEndpoint implements \Qdequippe\Yousign\Api\Runtime\Client\Endpoint
{
     ...
     * }
     */
    public function __construct(\Qdequippe\Yousign\Api\Model\SignatureUiInput $body, array $headerParameters = [])
    {
        $this->body = $body;
     ...
     * {@inheritdoc}
     *
     * @return \Qdequippe\Yousign\Api\Model\SignatureUiOutput|null
     */
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        if (200 === $status) {
            return $serializer->deserialize($body, 'Qdequippe\\Yousign\\Api\\Model\\SignatureUiOutput', 'json');
        }
    }
