...
class PutFileObjectById extends \Qdequippe\Yousign\Api\Runtime\Client\BaseEndpoint implements \Qdequippe\Yousign\Api\Runtime\Client\Endpoint
{
     ...
     * }
     */
    public function __construct(string $id, \Qdequippe\Yousign\Api\Model\FileObjectInput $body, array $headerParameters = [])
    {
        $this->id = $id;
        $this->body = $body;
     ...
     * {@inheritdoc}
     *
     * @return \Qdequippe\Yousign\Api\Model\FileObjectOutput|null
     */
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        if (200 === $status) {
            return $serializer->deserialize($body, 'Qdequippe\\Yousign\\Api\\Model\\FileObjectOutput', 'json');
        }
    }
