...
class PutProcedureById extends \Qdequippe\Yousign\Api\Runtime\Client\BaseEndpoint implements \Qdequippe\Yousign\Api\Runtime\Client\Endpoint
{
     ...
     * }
     */
    public function __construct(string $id, \Qdequippe\Yousign\Api\Model\ProcedureInput $body, array $headerParameters = [])
    {
        $this->id = $id;
        $this->body = $body;
    ...
    {
        return str_replace(['{id}'], [$this->id], '/procedures/{id}');
    }
    ...
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (400 === $status) {
            throw new \Qdequippe\Yousign\Api\Exception\PutProcedureByIdBadRequestException();
        }
        if (404 === $status) {
            throw new \Qdequippe\Yousign\Api\Exception\PutProcedureByIdNotFoundException();
        }
    }
