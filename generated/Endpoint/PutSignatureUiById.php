...
class PutSignatureUiById extends \Qdequippe\Yousign\Api\Runtime\Client\BaseEndpoint implements \Qdequippe\Yousign\Api\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{id}'], [$this->id], '/signature_uis/{id}');
    }
     ...
     * {@inheritdoc}
     *
     * @return \Qdequippe\Yousign\Api\Model\SignatureUiInputUpdate|null
     */
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        if (200 === $status) {
            return $serializer->deserialize($body, 'Qdequippe\\Yousign\\Api\\Model\\SignatureUiInputUpdate', 'json');
        }
    }
