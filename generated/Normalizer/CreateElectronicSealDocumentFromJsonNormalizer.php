...
if (!class_exists(Kernel::class) || (Kernel::MAJOR_VERSION >= 7 || Kernel::MAJOR_VERSION === 6 && Kernel::MINOR_VERSION === 4)) {
    class CreateElectronicSealDocumentFromJsonNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        use CheckArray;
        ...
        {
            return CreateElectronicSealDocumentFromJson::class === $type;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return \is_object($data) && CreateElectronicSealDocumentFromJson::class === $data::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new CreateElectronicSealDocumentFromJson();
        ...
        {
            return [CreateElectronicSealDocumentFromJson::class => false];
        }
    }
} else {
    class CreateElectronicSealDocumentFromJsonNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
