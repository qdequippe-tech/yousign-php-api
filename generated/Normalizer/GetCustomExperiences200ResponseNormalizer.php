...
if (!class_exists(Kernel::class) || (Kernel::MAJOR_VERSION >= 7 || Kernel::MAJOR_VERSION === 6 && Kernel::MINOR_VERSION === 4)) {
    class GetCustomExperiences200ResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        use CheckArray;
        ...
        {
            return GetCustomExperiences200Response::class === $type;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return \is_object($data) && Qdequippe\Yousign\Api\Model\GetCustomExperiences200Response::class === $data::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new GetCustomExperiences200Response();
            ...
            if (\array_key_exists('data', $data) && null !== $data['data']) {
                ...
                foreach ($data['data'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, CustomExperience::class, 'json', $context);
                }
        ...
        {
            return [GetCustomExperiences200Response::class => false];
        }
    }
} else {
    class GetCustomExperiences200ResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
