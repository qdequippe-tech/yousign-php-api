...
if (!class_exists(Kernel::class) || (Kernel::MAJOR_VERSION >= 7 || Kernel::MAJOR_VERSION === 6 && Kernel::MINOR_VERSION === 4)) {
    class GetWorkspaces200ResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        use CheckArray;
        ...
        {
            return GetWorkspaces200Response::class === $type;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return \is_object($data) && Qdequippe\Yousign\Api\Model\GetWorkspaces200Response::class === $data::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new GetWorkspaces200Response();
            ...
            if (\array_key_exists('data', $data) && null !== $data['data']) {
                ...
                foreach ($data['data'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, Workspace::class, 'json', $context);
                }
        ...
        {
            return [GetWorkspaces200Response::class => false];
        }
    }
} else {
    class GetWorkspaces200ResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
