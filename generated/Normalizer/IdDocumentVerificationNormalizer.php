...
if (!class_exists(Kernel::class) || (Kernel::MAJOR_VERSION >= 7 || Kernel::MAJOR_VERSION === 6 && Kernel::MINOR_VERSION === 4)) {
    class IdDocumentVerificationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        use CheckArray;
        ...
        {
            return IdDocumentVerification::class === $type;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return \is_object($data) && IdDocumentVerification::class === $data::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new IdDocumentVerification();
            ...
            if (\array_key_exists('extracted_from_document', $data) && null !== $data['extracted_from_document']) {
                $object->setExtractedFromDocument($this->denormalizer->denormalize($data['extracted_from_document'], IdDocumentVerificationExtractedFromDocument::class, 'json', $context));
        ...
        {
            return [IdDocumentVerification::class => false];
        }
    }
} else {
    class IdDocumentVerificationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
