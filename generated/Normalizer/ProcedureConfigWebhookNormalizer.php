...
class ProcedureConfigWebhookNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return 'Qdequippe\\Yousign\\Api\\Model\\ProcedureConfigWebhook' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return \is_object($data) && 'Qdequippe\\Yousign\\Api\\Model\\ProcedureConfigWebhook' === \get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Qdequippe\Yousign\Api\Model\ProcedureConfigWebhook();
        ...
        if (\array_key_exists('procedure.finished', $data) && null !== $data['procedure.finished']) {
            ...
            foreach ($data['procedure.finished'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Qdequippe\\Yousign\\Api\\Model\\ConfigWebhookTemplate', 'json', $context);
            }
        ...
        if (\array_key_exists('procedure.refused', $data) && null !== $data['procedure.refused']) {
            ...
            foreach ($data['procedure.refused'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Qdequippe\\Yousign\\Api\\Model\\ConfigWebhookTemplate', 'json', $context);
            }
        ...
        if (\array_key_exists('procedure.expired', $data) && null !== $data['procedure.expired']) {
            ...
            foreach ($data['procedure.expired'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Qdequippe\\Yousign\\Api\\Model\\ConfigWebhookTemplate', 'json', $context);
            }
        ...
        if (\array_key_exists('procedure.deleted', $data) && null !== $data['procedure.deleted']) {
            ...
            foreach ($data['procedure.deleted'] as $value_4) {
                $values_4[] = $this->denormalizer->denormalize($value_4, 'Qdequippe\\Yousign\\Api\\Model\\ConfigWebhookTemplate', 'json', $context);
            }
        ...
        if (\array_key_exists('procedure.error', $data) && null !== $data['procedure.error']) {
            $values_5 = [];
            foreach ($data['procedure.error'] as $value_5) {
                $values_5[] = $this->denormalizer->denormalize($value_5, 'Qdequippe\\Yousign\\Api\\Model\\ConfigWebhookTemplate', 'json', $context);
            }
            $object->setProcedureError($values_5);
        } elseif (\array_key_exists('procedure.error', $data) && null === $data['procedure.error']) {
            $object->setProcedureError(null);
        }
        if (\array_key_exists('member.started', $data) && null !== $data['member.started']) {
            $values_6 = [];
            foreach ($data['member.started'] as $value_6) {
                $values_6[] = $this->denormalizer->denormalize($value_6, 'Qdequippe\\Yousign\\Api\\Model\\ConfigWebhookTemplate', 'json', $context);
            }
            $object->setMemberStarted($values_6);
        ...
        if (\array_key_exists('member.finished', $data) && null !== $data['member.finished']) {
            $values_7 = [];
            foreach ($data['member.finished'] as $value_7) {
                $values_7[] = $this->denormalizer->denormalize($value_7, 'Qdequippe\\Yousign\\Api\\Model\\ConfigWebhookTemplate', 'json', $context);
            }
            $object->setMemberFinished($values_7);
        ...
        if (\array_key_exists('comment.created', $data) && null !== $data['comment.created']) {
            $values_8 = [];
            foreach ($data['comment.created'] as $value_8) {
                $values_8[] = $this->denormalizer->denormalize($value_8, 'Qdequippe\\Yousign\\Api\\Model\\ConfigWebhookTemplate', 'json', $context);
            }
            $object->setCommentCreated($values_8);
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if (null !== $object->getProcedureError()) {
            $values_5 = [];
            foreach ($object->getProcedureError() as $value_5) {
                $values_5[] = $this->normalizer->normalize($value_5, 'json', $context);
            }
            $data['procedure.error'] = $values_5;
        }
        if (null !== $object->getMemberStarted()) {
            $values_6 = [];
            foreach ($object->getMemberStarted() as $value_6) {
                $values_6[] = $this->normalizer->normalize($value_6, 'json', $context);
            }
            $data['member.started'] = $values_6;
        }
        if (null !== $object->getMemberFinished()) {
            $values_7 = [];
            foreach ($object->getMemberFinished() as $value_7) {
                $values_7[] = $this->normalizer->normalize($value_7, 'json', $context);
            }
            $data['member.finished'] = $values_7;
        }
        if (null !== $object->getCommentCreated()) {
            $values_8 = [];
            foreach ($object->getCommentCreated() as $value_8) {
                $values_8[] = $this->normalizer->normalize($value_8, 'json', $context);
            }
            $data['comment.created'] = $values_8;
        }
