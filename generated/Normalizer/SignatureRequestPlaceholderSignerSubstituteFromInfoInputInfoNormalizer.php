...
if (!class_exists(Kernel::class) || (Kernel::MAJOR_VERSION >= 7 || Kernel::MAJOR_VERSION === 6 && Kernel::MINOR_VERSION === 4)) {
    class SignatureRequestPlaceholderSignerSubstituteFromInfoInputInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        use CheckArray;
        ...
        {
            return SignatureRequestPlaceholderSignerSubstituteFromInfoInputInfo::class === $type;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return \is_object($data) && Qdequippe\Yousign\Api\Model\SignatureRequestPlaceholderSignerSubstituteFromInfoInputInfo::class === $data::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new SignatureRequestPlaceholderSignerSubstituteFromInfoInputInfo();
        ...
        {
            return [SignatureRequestPlaceholderSignerSubstituteFromInfoInputInfo::class => false];
        }
    }
} else {
    class SignatureRequestPlaceholderSignerSubstituteFromInfoInputInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
