...
class SignatureUiInputUpdateNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return 'Qdequippe\\Yousign\\Api\\Model\\SignatureUiInputUpdate' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return \is_object($data) && 'Qdequippe\\Yousign\\Api\\Model\\SignatureUiInputUpdate' === \get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Qdequippe\Yousign\Api\Model\SignatureUiInputUpdate();
        ...
        if (\array_key_exists('fonts', $data) && null !== $data['fonts']) {
            $values_2 = [];
            foreach ($data['fonts'] as $value_2) {
                $values_2[] = $value_2;
            }
            $object->setFonts($values_2);
        ...
        if (\array_key_exists('redirectCancel', $data) && null !== $data['redirectCancel']) {
            $object->setRedirectCancel($this->denormalizer->denormalize($data['redirectCancel'], 'Qdequippe\\Yousign\\Api\\Model\\SignatureUiInputUpdateRedirectCancel', 'json', $context));
        ...
        if (\array_key_exists('redirectError', $data) && null !== $data['redirectError']) {
            $object->setRedirectError($this->denormalizer->denormalize($data['redirectError'], 'Qdequippe\\Yousign\\Api\\Model\\SignatureUiInputUpdateRedirectError', 'json', $context));
        ...
        if (\array_key_exists('redirectSuccess', $data) && null !== $data['redirectSuccess']) {
            $object->setRedirectSuccess($this->denormalizer->denormalize($data['redirectSuccess'], 'Qdequippe\\Yousign\\Api\\Model\\SignatureUiInputUpdateRedirectSuccess', 'json', $context));
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if (null !== $object->getFonts()) {
            $values_2 = [];
            foreach ($object->getFonts() as $value_2) {
                $values_2[] = $value_2;
            }
            $data['fonts'] = $values_2;
        }
