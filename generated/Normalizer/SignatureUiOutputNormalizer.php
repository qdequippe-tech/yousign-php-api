...
class SignatureUiOutputNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Qdequippe\\Yousign\\Api\\Model\\SignatureUiOutput' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return \is_object($data) && 'Qdequippe\\Yousign\\Api\\Model\\SignatureUiOutput' === \get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Qdequippe\Yousign\Api\Model\SignatureUiOutput();
        ...
        if (\array_key_exists('labels', $data) && null !== $data['labels']) {
            ...
            foreach ($data['labels'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Qdequippe\\Yousign\\Api\\Model\\SignatureUiLabelOutput', 'json', $context);
            }
        ...
        if (\array_key_exists('redirectCancel', $data) && null !== $data['redirectCancel']) {
            $object->setRedirectCancel($this->denormalizer->denormalize($data['redirectCancel'], 'Qdequippe\\Yousign\\Api\\Model\\SignatureUiOutputRedirectCancel', 'json', $context));
        ...
        if (\array_key_exists('redirectError', $data) && null !== $data['redirectError']) {
            $object->setRedirectError($this->denormalizer->denormalize($data['redirectError'], 'Qdequippe\\Yousign\\Api\\Model\\SignatureUiOutputRedirectError', 'json', $context));
        ...
        if (\array_key_exists('redirectSuccess', $data) && null !== $data['redirectSuccess']) {
            $object->setRedirectSuccess($this->denormalizer->denormalize($data['redirectSuccess'], 'Qdequippe\\Yousign\\Api\\Model\\SignatureUiOutputRedirectSuccess', 'json', $context));
